...
@Component({
  selector: 'app-my-event-products-add',
  templateUrl: './my-event-products-add.component.html',
  styleUrls: ['./my-event-products-add.component.css']
})

export class MyeventProductsAddComponent implements OnInit {
