...
@Component({
  selector: 'app-my-event-products-list',
  templateUrl: './my-event-products-list.component.html',
  styleUrls: ['./my-event-products-list.component.css']
})
export class MyeventProductsListComponent implements OnInit {
